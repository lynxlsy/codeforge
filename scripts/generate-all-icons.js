...
// Template para todos os ícones usando a logo original do CDforge
const iconTemplate = (size, isIOS = false) => `<?xml version="1.0" encoding="UTF-8"?>
<svg width="${size}" height="${size}" viewBox="0 0 ${size} ${size}" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Background -->
  <rect width="${size}" height="${size}" rx="${isIOS ? 0 : size * 0.2}" fill="url(#bg)"/>
  
  <!-- Logo Original do CDforge centralizado -->
  <g transform="translate(${size/2}, ${size/2}) scale(${size/543}, ${size/567})">
  ...
  <!-- Subtle border -->
  <rect width="${size}" height="${size}" rx="${isIOS ? 0 : size * 0.2}" fill="none" stroke="#3B82F6" stroke-width="${Math.max(1, size/256)}" opacity="0.3"/>
</svg>`;
...
iconSizes.forEach(size => {
  ...
  fs.writeFileSync(filepath, iconTemplate(size, false));
...
iosIconSizes.forEach(size => {
  ...
  fs.writeFileSync(filepath, iconTemplate(size, true));
  console.log(`✅ Gerado: ${filename}`);
});

// Gerar ícones para shortcuts
const devShortcutIcon = `<?xml version="1.0" encoding="UTF-8"?>
<svg width="96" height="96" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Logo Original do CDforge -->
  <g transform="translate(48, 48) scale(0.177, 0.169)">
    <g fill="#3B82F6" stroke="none">
      <path d="M2505 4923 c-98 -21 -116 -53 -161 -272 -49 -247 -67 -279 -162 -306
      -31 -9 -64 -19 -72 -22 -8 -3 -17 -7 -20 -8 -3 -1 -18 -7 -35 -14 -16 -7 -61
      -24 -100 -38 -38 -14 -95 -38 -125 -53 -51 -25 -58 -26 -105 -15 -27 6 -77 29
  ...
  <text x="72" y="28" font-family="Arial, sans-serif" font-size="8" font-weight="bold" text-anchor="middle" fill="white">D</text>
</svg>`;

const funcShortcutIcon = `<?xml version="1.0" encoding="UTF-8"?>
<svg width="96" height="96" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:#1f2937;stop-opacity:1" />
  ...
  <circle cx="72" cy="24" r="8" fill="#10B981"/>
  <text x="72" y="28" font-family="Arial, sans-serif" font-size="8" font-weight="bold" text-anchor="middle" fill="white">F</text>
</svg>`;

fs.writeFileSync(path.join(iconsDir, 'dev-shortcut.svg'), devShortcutIcon);
fs.writeFileSync(path.join(iconsDir, 'func-shortcut.svg'), funcShortcutIcon);

console.log('✅ Gerado: dev-shortcut.svg');
console.log('✅ Gerado: func-shortcut.svg');

console.log('\n🎉 Todos os ícones foram gerados usando a logo original do CDforge!');
console.log('📱 Agora o iPhone e todos os dispositivos vão mostrar a logo original!');
