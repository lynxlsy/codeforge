...
// Template para os ícones com a logo original do CDforge (sem fundo gradiente)
const iconTemplate = (size) => `<?xml version="1.0" encoding="UTF-8"?>
<svg width="${size}" height="${size}" viewBox="0 0 ${size} ${size}" xmlns="http://www.w3.org/2000/svg">
  <!-- Logo Original do CDforge centralizado -->
  <g transform="translate(${size/2}, ${size/2}) scale(${size/543}, ${size/567}) translate(-271.5, -283.5)">
...
// Gerar ícones para shortcuts (versão simplificada)
const devShortcutIcon = `<?xml version="1.0" encoding="UTF-8"?>
<svg width="96" height="96" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
  <!-- Logo Original do CDforge centralizado -->
  <g transform="translate(48, 48) scale(0.17679558011049723, 0.1693121693121693) translate(-271.5, -283.5)">
    <g fill="#3B82F6" stroke="none">
      <path d="M2505 4923 c-98 -21 -116 -53 -161 -272 -49 -247 -67 -279 -162 -306
      -31 -9 -64 -19 -72 -22 -8 -3 -17 -7 -20 -8 -3 -1 -18 -7 -35 -14 -16 -7 -61
      -24 -100 -38 -38 -14 -95 -38 -125 -53 -51 -25 -58 -26 -105 -15 -27 6 -77 29
...
console.log('\n🎉 Todos os ícones PWA com a logo original do CDforge foram gerados!');
console.log('📱 Agora quando o CDforge for adicionado à tela inicial, aparecerá a logo oficial sem fundo gradiente!');
